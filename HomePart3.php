...
if (!isset($_SESSION['user_id'])) {
    ...
    $firstLetter = strtoupper($username[0]); // Extract and capitalize the first letter
    $loginMessage = $firstLetter;
    $loginMessage = "Welcome, $user_name! <a href='logout.php'>Log out</a>";
}
?>
        ...
        <div class="nav">
            ...
            <div class="right">
                ...
                <div class="book_scroll_container">
                            ...
                            $sql1 = "SELECT id, title, authors, publisher, cover_url, description, Faculte, COUNT(views) AS view_count
                                        FROM Books
